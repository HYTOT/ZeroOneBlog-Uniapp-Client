...
/* harmony import */ var vue_class_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! vue-class-component */ 19);
...
var _uniAppAxios = _interopRequireDefault(__webpack_require__(/*! uni-app-axios */ 29));

var _mockMapper = __webpack_require__(/*! ./mockMapper */ 38);
...
axios.interceptors.request.use(function (config) {
  ...
  requestUrl = (_config$url = config.url) === null || _config$url === void 0 ? void 0 : _config$url.replace(axios.defaults.url, '');
  console.log(config);
  return config;
}, function (error) {
...
axios.interceptors.response.use(function (response) {
  ...
  // 响应信息错误则返回假数据
  return _mockMapper.mockMapper[(_requestUrl = requestUrl) === null || _requestUrl === void 0 ? void 0 : _requestUrl.split('?')[0]];
});
var _default = axios;
exports.default = _default;
...
/* 29 */
/*!*********************************************!*\
  !*** ./node_modules/uni-app-axios/index.js ***!
  \*********************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _src_lib_method_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./src/lib/method.js */ 30);
/* harmony import */ var _src_lib_parameter_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./src/lib/parameter.js */ 31);
/* harmony import */ var _src_lib_mixin_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./src/lib/mixin.js */ 33);
/* harmony import */ var _src_lib_intercept_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./src/lib/intercept.js */ 35);
/* harmony import */ var _src_CopyProxy__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./src/CopyProxy */ 36);
/* harmony import */ var _utils_finally__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./utils/finally */ 37);
...
Object(_utils_finally__WEBPACK_IMPORTED_MODULE_5__["default"])();
/**
 * options：Object,默认Object，设置默认的request参数
 * proxt：Boolean，默认为true，是否将wx的所有api都封装成Promise
 */
function Api(options = {}, proxy = true) {
    //默认为get
    ...
    //导入method方法
    Object(_src_lib_method_js__WEBPACK_IMPORTED_MODULE_0__["default"])(api);
    //设置默认参数
    Object(_src_lib_parameter_js__WEBPACK_IMPORTED_MODULE_1__["default"])(api);
    //混入默认配置
    Object(_src_lib_mixin_js__WEBPACK_IMPORTED_MODULE_2__["default"])(api);
    //导入拦截方法
    Object(_src_lib_intercept_js__WEBPACK_IMPORTED_MODULE_3__["default"])(api);
    /**
     *options 设置defaults
     */
    api.build = function (options, proxy) {
        let cp = new _src_CopyProxy__WEBPACK_IMPORTED_MODULE_4__["default"](this);
        let obj = cp.clone();
        if (proxy)
...
/* 30 */
/*!******************************************************!*\
  !*** ./node_modules/uni-app-axios/src/lib/method.js ***!
  \******************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 31 */
/*!*********************************************************!*\
  !*** ./node_modules/uni-app-axios/src/lib/parameter.js ***!
  \*********************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _interceptors_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./interceptors.js */ 32);


function parameter(api) {
    api.defaults = {
        url: '',
        method: 'get',
        dataType: 'json',
    ...
    api.interceptors = {
        response: Object(_interceptors_js__WEBPACK_IMPORTED_MODULE_0__["default"])(),
        request: Object(_interceptors_js__WEBPACK_IMPORTED_MODULE_0__["default"])()
    };
}
...
/* 32 */
/*!************************************************************!*\
  !*** ./node_modules/uni-app-axios/src/lib/interceptors.js ***!
  \************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 33 */
/*!*****************************************************!*\
  !*** ./node_modules/uni-app-axios/src/lib/mixin.js ***!
  \*****************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _utils_common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../utils/common */ 34);
...
function mixin(api) {
    ...
    api.pathMerge = function (url) {
        return Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["isProtocol"])(url) ? url : this.defaults.url + url;
    };
...
/* 34 */
/*!****************************************************!*\
  !*** ./node_modules/uni-app-axios/utils/common.js ***!
  \****************************************************/
/*! exports provided: newObj, isProtocol */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "newObj", function() { return newObj; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isProtocol", function() { return isProtocol; });
/**
 * 克隆一个全新对象，但不能对dom对象和function
 * */
let newObj = obj => JSON.parse(JSON.stringify(obj));
...
/* 35 */
/*!*********************************************************!*\
  !*** ./node_modules/uni-app-axios/src/lib/intercept.js ***!
  \*********************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(uni) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return intercept; });
function intercept(api) {
    //包装成Promise返回
...
/* 36 */
/*!*****************************************************!*\
  !*** ./node_modules/uni-app-axios/src/CopyProxy.js ***!
  \*****************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return CopyProxy; });
...
/* 37 */
/*!*****************************************************!*\
  !*** ./node_modules/uni-app-axios/utils/finally.js ***!
  \*****************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = (getFinally);


/***/ }),
/* 38 */
/*!********************************!*\
  !*** ./src/http/mockMapper.ts ***!
  \********************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.mockMapper = void 0;

var _mockjs = _interopRequireDefault(__webpack_require__(/*! mockjs */ 39));
...
function parseBaseApp (vm, {
  ...
  vue__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.mpHost = "app-plus";
